...
function getCurrentQuestion() {
  if (currentStep === 0) {
    return {
      ...
      answers: [
        { value: "plan_long", icon: "🌱", title: "Ich plane langfristig", micro: "Zukunft ist mir wichtig." },
        { value: "plan_mid", icon: "🧭", title: "Ich plane mittelfristig", micro: "Ich will Dinge sauber sortieren." },
        { value: "plan_short", icon: "⚡", title: "Ich plane kurzfristig", micro: "Erstmal das, was jetzt zählt." },
